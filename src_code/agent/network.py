...
# def residual_block(x, filters, block_idx, l1=0.01, l2=0.01, dropout_rate=0.5):
...
#
#     # Residual blocks
#     x = Conv2D(256, kernel_size=3, padding='same', name='conv1', kernel_regularizer=l1_l2(l1=0.0001, l2=0.0001))(inputs)
...
#
#     # Value head
#     v = Conv2D(1, kernel_size=1, padding='same', name='value_conv', kernel_regularizer=l1_l2(l1=0.01, l2=0.01))(x)
#     v = BatchNormalization(name='value_bn')(v)
#     v = Activation('relu', name='value_relu')(v)
#     v = Flatten(name='value_flatten')(v)
#     v = Dense(256, activation='relu', kernel_initializer='lecun_uniform', name='value_dense1', kernel_regularizer=l1_l2(l1=0.01, l2=0.01))(v)
#     v = Dropout(0.5)(v)
#     v = Dense(1, activation='tanh', kernel_initializer='lecun_uniform', name='value', kernel_regularizer=l1_l2(l1=0.01, l2=0.01))(v)
#
#     # Policy head
#     p = Conv2D(2, kernel_size=1, padding='same', name='policy_conv', kernel_regularizer=l1_l2(l1=0.01, l2=0.01))(x)
#     p = BatchNormalization(name='policy_bn')(p)
#     p = Activation('relu', name='policy_relu')(p)
#     p = Flatten(name='policy_flatten')(p)
#     p = Dense(config.action_space_size, activation='softmax', name='policy', kernel_regularizer=l1_l2(l1=0.01, l2=0.01))(p)
#     p = Dropout(0.5)(p)
#

...
def residual_block(x, filters, block_idx, l1=0.000001, l2=0.000001, dropout_rate=0.5):
...
def create_network(config, network_type, l1=0.000001, l2=0.000001, dropout_rate=0.5):
    # Input layer

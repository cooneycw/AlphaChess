...
def residual_block(x, filters, block_idx, l1, l2, rb_dropout_rate=0.03):
...
def create_network(config, l1=0, l2=0.000001, dropout_rate=0.3):
    # Input layer
    ...
    v = Dense(256, activation=leaky_relu, kernel_initializer='glorot_uniform', name='value_dense1')(v)
